...
// Re-exported so existing importers keep working after the preset logic
// moved to hooks/useFilterPresets (2026-06 L2 decomposition).
export type { FilterPreset } from '@/hooks/useFilterPresets';
import {
...
export default function FilterPanel({
  ...
  // Saved-search + journal presets (state, persistence, divergence
  // detection) live in hooks/useFilterPresets — extracted in the
  ...
  const {
    ...
    loadJournalPreset,
    deleteJournalPreset,
  } = useFilterPresets({ filters, setFilters, query, onPresetLoad });
