...
`;
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
      <div className='absolute inset-0 overlay-soft' onClick={onClose} />
      <div className='relative surface-card border border-app rounded-xl shadow-xl max-w-xl w-full max-h-[85vh] overflow-hidden'>
        {/* Header */}
        ...
        <div className='p-5 overflow-y-auto max-h-[calc(85vh-130px)] space-y-5'>
          ...
          <div className='surface-muted rounded-lg p-4'>
            ...
            <ol className='text-xs text-stone-600 space-y-1.5 list-decimal list-inside'>
              ...
              <li>
                Add{' '}
                <code className='surface-subtle px-1 rounded'>
                  check_papers.py
                </code>{' '}
                to root
              </li>
          ...
          {/* Secrets reminder */}
          <div className='banner-info rounded-lg p-3'>
            <p className='text-xs text-accent-strong'>
              <strong>Required secrets:</strong>{' '}
              <code className='surface-card px-1 rounded'>MAILTO</code>,{' '}
              <code className='surface-card px-1 rounded'>MAILJET_API_KEY</code>,{' '}
              <code className='surface-card px-1 rounded'>
                MAILJET_SECRET_KEY
              </code>
              , <code className='surface-card px-1 rounded'>TO_EMAIL</code>
            </p>
          </div>

          {/* Files */}
          {files.map((file) => (
            <div key={file.id} className='border border-app rounded-lg'>
              <div className='flex items-center justify-between px-3 py-2 surface-muted border-b border-app'>
                ...
                <div className='flex items-center gap-1'>
                  <button
                    ...
                    className='p-1 hover:bg-[var(--surface-subtle)] rounded transition'
          ...
          <div className='border border-app rounded-lg'>
            ...
            <pre className='p-3 text-[10px] overflow-x-auto surface-muted text-stone-600 break-all'>
              {buildOpenAlexUrl()}
            </pre>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className='flex items-center justify-between px-5 py-3 border-t border-app surface-muted'>
          <button
            onClick={onClose}
          ...
          <button
            onClick={downloadAll}
            className='flex items-center gap-1.5 px-4 py-2 button-primary rounded-lg transition text-xs font-medium'
          >
            <Download size={14} />
            Download All
          </button>
